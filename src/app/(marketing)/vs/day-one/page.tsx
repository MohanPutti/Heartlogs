...
export const metadata: Metadata = {
  ...
  description:
    "Comparing HeartLogs and Day One journal app? See a side-by-side breakdown of price, platforms, privacy, and features to find the best digital diary for you.",
  alternates: { canonical: "/vs/day-one" },
  openGraph: {
    title: "HeartLogs vs Day One — Free Online Diary Comparison",
    description:
      "A side-by-side comparison of HeartLogs and Day One: price, platforms, privacy, and features.",
    url: "https://heartlogs.com/vs/day-one",
    siteName: "HeartLogs",
    type: "website",
    locale: "en_US",
  },
  twitter: {
    ...
    title: "HeartLogs vs Day One",
    description: "See how HeartLogs compares to Day One as a free online diary alternative.",
  },
};

const rows = [
  { label: "Price", heartlogs: "Free forever", other: "Free tier limited; premium subscription for sync & unlimited entries" },
  { label: "Platform", heartlogs: "Any browser — phone, tablet, or computer", other: "iOS and Mac primarily; web and Android are limited" },
  ...
  { label: "Entry limit on free tier", heartlogs: "None", other: "Capped entries and photos" },
];

const faqs = [
  {
    q: "Is HeartLogs a good free alternative to Day One?",
    a: "Yes. HeartLogs offers mood tracking, tags, full-text search, and calendar navigation — core features Day One users rely on — completely free, with no entry limits and no subscription required.",
  },
  {
    q: "Does HeartLogs work on Android and Windows like Day One's web app?",
    a: "Yes. HeartLogs is a web app that works identically on any device with a browser, including Android, Windows, Linux, iOS, and Mac — no native app installation required.",
  },
  {
    q: "Why would I choose Day One over HeartLogs?",
    a: "Day One offers native iOS/Mac apps with offline support and features like photo-heavy entries and Apple Watch integration. If you're deep in the Apple ecosystem and want a native app experience, Day One may suit you better. If you want a free, private, browser-based diary with no subscription, HeartLogs is built for that.",
  },
];

export default function DayOneComparisonPage() {
  const jsonLd = {
    ...
    <div className="min-h-screen flex flex-col" style={{ background: "var(--bg)", color: "var(--text-primary)" }}>
      ...
      <section className="text-center px-6 pt-16 pb-12">
        <h1 className="font-display text-3xl md:text-5xl font-bold mb-4" style={{ color: "var(--text-primary)" }}>
          HeartLogs vs Day One
        </h1>
        <p className="text-base max-w-xl mx-auto" style={{ color: "var(--text-muted)" }}>
          Both are popular digital diary apps, but they take different approaches. Here&apos;s an honest comparison
          to help you pick the right private journal.
        </p>
      </section>
      ...
      <section className="px-6 md:px-12 pb-16 max-w-3xl mx-auto w-full overflow-x-auto">
        <table className="w-full border-collapse text-sm min-w-[480px]">
          <thead>
            <tr className="border-b" style={{ borderColor: "var(--border)" }}>
              ...
              <th className="text-left py-3 font-semibold" style={{ color: "var(--text-primary)" }}>Day One</th>
            </tr>
          </thead>
          <tbody>
            {rows.map((row) => (
        ...
        <p className="text-xs mt-4" style={{ color: "var(--text-muted)" }}>
          Day One is a trademark of its respective owner. Pricing and features can change — check their site for current details.
        </p>
      </section>
      ...
      >
        <h2 className="font-display text-2xl md:text-3xl font-bold mb-3" style={{ color: "var(--text-primary)" }}>
          Try the free alternative to Day One
        </h2>
